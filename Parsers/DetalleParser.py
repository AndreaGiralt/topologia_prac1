...
class DetalleParser(scrapy.Spider):
    ...
    def start_requests(self):
        # TODO recoger los ids del mapa de pisos.com



        detail_url = self.base_url + "/v5//detail/properties/previews?ids=15042766476.100100|11734865252.100100|9179150976.101800|15068896029.100500|11684468505.100500|9221862914.101800|740828453.500208|15050995393.500208|12519645181.290100|15030398320.100500|13372031380.991722|10895788692.501477|14217353890.501477|15909343813.100500|15083354267.109300|45090245.290100|12536365843.991722|119438692.429400|15891954495.429400|16738680751.100500|93408041533.100500|13364854221.999214|14166900781.100500|15890532414.100500|14264394614.100100&cu=es&apikey=732df30bad6bb3916e9a1c2a5d46377b"
    ...
    def parse_response(self, response, **kwargs):
        ...
        date = dt.isoformat()
        with open('results/crawler_ids_{}.json'.format(date), 'w') as file:
            file.write(response.text)

        header = ['id', 'superficie', 'habitaciones', 'banyos', 'url',
                  'price', 'price_old', 'long', 'lat', 'exact_position', 'zone_name', 'phone', 'aditional_number',
                  'is_visible_phone'
                  'owner_id', 'recently_date', 'owner_name', 'is_promotion'
                                                             'promotion_name', 'promotion_url', 'main_product_name', ]
